        ...
        <div className='room-in-search'>
             ...
             <div className='room-photos'> 
                {  isSkelet ? 
                    ...
                    <div className='blink room-main-photo' style={{backgroundColor:'Silver'}}>
                    </div> 
                    <div className='room-other-photo'>
                        <div className='rooms-image' style={{backgroundColor:'Silver', width:'90px', height:"80px"}}></div>
                        <div className='rooms-image' style={{backgroundColor:'Silver', width:'90px', height:"80px"}}></div>
                        <div className='rooms-image' style={{backgroundColor:'Silver', width:'90px', height:"80px"}}></div>
                    </div>
                    </div>:
